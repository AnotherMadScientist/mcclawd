...
pub fn format_outbound(
    ...
    match chunk {
        ...
        OutboundChunk::UserMessage(_) | OutboundChunk::ToolStart { .. } | OutboundChunk::ToolEnd { .. } | OutboundChunk::Done | OutboundChunk::Attachments(_) | OutboundChunk::Usage { .. } | OutboundChunk::ChatHistory(_) | OutboundChunk::GeneratedFiles(_) => {
            None
        }
    }
}
